	...
	<div class = "container">
		<div class = "row">
			...
			<div class = "col-sm-12" >
				...
				<a href="#steps"><h4>Just follow the steps below! To get a chance to win a shadow fiend arcana!</h4></a>
				</div>
			</div>
			<div class = "col-sm-12">
		...
		<div class = "row">
			<div class = "col-sm-12" id = "steps">
				...
				<br>
				<ol>
					<li><h5>Login your VPGAME account <a href = "#login">here</a></h5></li>
				</ol>
				<br>
			</div>
		</div>
				...
				<div class = "col-sm-12 col-md-6 col-lg-6">
					<div class="card" id = "login">
					  ...
					  <div class="card-block">
					    <h5 class="card-title">VPGAME account login</h5>
					    <div class="form-group">
						    <!-- <label for="formGroupExampleInput">Email address :</label> -->
						    <input type="text" class="form-control" name = "email" id="formGroupExampleInput" placeholder = "Username / Email"required>
						  </div>
						  <div class="form-group">
						    <label for="formGroupExampleInput2"></label>
						    <input type="password" class="form-control" name = "pass" id="formGroupExampleInput2" placeholder = "Password">
						  	<input type = "hidden" name = "type" value = "vpaccount">
						  </div>
